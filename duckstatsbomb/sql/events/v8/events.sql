        ...
        unnest(
            from_json(
                ...
                '[{"id": "varchar",
                   ...
                   "pass": "struct(recipient struct(id ubigint, name varchar), length double, angle double, height struct(id ubigint, name varchar), end_location double[], assisted_shot_id varchar, backheel boolean, deflected boolean, miscommunication boolean, \"cross\" boolean, cut_back boolean, switch boolean, shot_assist boolean, goal_assist boolean, body_part struct(id ubigint, name varchar), type struct(id ubigint, name varchar), outcome struct(id ubigint, name varchar), technique struct(id ubigint, name varchar), pass_cluster_id ubigint, pass_cluster_label varchar, pass_cluster_probability double, pass_success_probability double, aerial_won boolean, no_touch boolean)",
                   "player_off": "struct(permanent boolean)",
                   "pressure": "struct(counterpress boolean)",
                   "shot": "struct(key_pass_id varchar, end_location double[], aerial_won boolean, follows_dribble boolean, first_time boolean, open_goal boolean, one_on_one boolean, statsbomb_xg double, gk_save_dificulty_xg double, shot_execution_xg double, shot_execution_xg_uplift double, gk_positioning_xg_suppression double, gk_shot_stopping_xg_suppression double, deflected boolean, technique struct(id ubigint, name varchar), shot_assist boolean, goal_assist boolean, body_part struct(id ubigint, name varchar), type struct(id ubigint, name varchar), outcome struct(id ubigint, name varchar), redirect boolean)",
...
final as (
    select
        ...
        coalesce(json.pass.shot_assist, json.shot.shot_assist) as shot_assist,
        coalesce(json.pass.goal_assist, json.shot.goal_assist) as goal_assist,
        ...
        json.shot.gk_save_dificulty_xg as gk_save_dificulty_xg,
        json.shot.shot_execution_xg as shot_execution_xg,
        json.shot.shot_execution_xg_uplift as shot_execution_xg_uplift,
        json.shot.gk_positioning_xg_suppression as gk_positioning_xg_suppression,
        json.shot.gk_shot_stopping_xg_suppression as gk_shot_stopping_xg_suppression,
