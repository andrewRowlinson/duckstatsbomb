    ...
    from
        read_json(
            ...
            pass: 'struct(
                ...
                outcome struct(id ubigint, name varchar),
                technique struct(id ubigint, name varchar),
                pass_cluster_id ubigint,
                pass_cluster_label varchar,
                pass_cluster_probability double,
                pass_success_probability double,
            ...
            shot: 'struct(
                ...
                one_on_one boolean,
                statsbomb_xg double,
                gk_save_difficulty_xg double,
                shot_execution_xg double,
                shot_execution_xg_uplift double,
                gk_positioning_xg_suppression double,
                gk_shot_stopping_xg_suppression double,
                deflected boolean,
                technique struct(id ubigint, name varchar),
...
final as (
    select
        ...
        pass.pass_cluster_label,
        pass.pass_cluster_probability,
        pass.pass_success_probability,
        ...
        shot.gk_save_difficulty_xg,
        shot.shot_execution_xg,
        shot.shot_execution_xg_uplift,
        shot.gk_positioning_xg_suppression,
        shot.gk_shot_stopping_xg_suppression,
